namespace SoundFingerprinting.FFT.FFTW.X86
{
    ...
    {
#if WINDOWS_UWP
        private const string DLL_PATH = @"SoundFingerprinting.UWP\x86\libfftw3f-3.dll";
#else
        private const string DLL_PATH = @"x86\libfftw3f-3.dll";
#endif
        ...
        [DllImport(DLL_PATH, EntryPoint = "fftwf_malloc", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <param name="output">Pointer to an array of 8-byte complex numbers</param>
        /// <param name="flags">Flags that specify the behavior of the planner</param>
        [DllImport(DLL_PATH, EntryPoint = "fftwf_plan_dft_r2c_1d", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
